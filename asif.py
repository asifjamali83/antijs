...
import youtube_dl
#=============
cl = LineClient(authToken='EG2Fqscd6BaA8ucIR8Qb.iEKLQqr+KXdSVGWpsvd/QW.YGLyzoH2i1JS5IZf+66jcbSDwv9UHSYBiyhurXxA2U4=')
...
ki = LineClient(authToken='EGNqM7zjtWyCAFnq35Qc.CCslx0hiYMYz0Wkvw5ctJa.9b9SOhHcZ3Sq9j0tXU6kGXD37LVzmB99JgxWrFxgxII=')
...
kk = LineClient(authToken='EGPpHMiqfotcGYCGjP77.4ciXpOp+ngV1ye23dcM5vW.Rx7OErKa03Sq7B/wn3pbC+qohHIdxsdeHfsD6RK1WDw=')
...
kc = LineClient(authToken='EGZpdQaE9FQDW4kwkQAa.uA70OmZ6xGXhLjifkBHlgG.Ir7xoVuHPPrQuWr3NgH9kBKhNkNan/3RCsLAsjDEBKs=')
...
km = LineClient(authToken='EGshlCfF2vIk5MIJx8Jb.bAXEGo6vXQI0VRhomlb3MW.Slq+IRPcWI6kfr2Pi8Up78KpX9juYBfDy6xN483yFLg==')
...
kb = LineClient(authToken='EGkOkfrOUPYm8Gv2Cid9.sq7xakrN1v28/yW8CSq42q.zKOZOHKNGL7WJEQPD8T6aOpYuS0YnQ1SeMRWG001ODo=')
...
kn = LineClient(authToken='EG947UH1WVi2nZ4lVov7.t/IdFcgcW7pVEtQdsL6WzW.k35KXUFk7kJ1NqltP9SLXcgZrlx8Qh2gQKVAG87S8jM=')
...
ko = LineClient(authToken='EGibcl5XYexllmVwahMd.JZJ/1Jhb9oyNKqIA+uiyFq.Fo6yaxCLuTNVP8f+cTd0w/hugquvpQzfad8NqcQI3/Q=')
...
kw = LineClient(authToken='EG6xehT8v843TZf7Ctn5.hY1gor5CBWozmN09XaJ2nq.fQgesldYCGQSI9lqcWb+4VWhMU8ZLHeOf2gbK7aBaRw=')
...
ke = LineClient(authToken='EGZuvlN1i4kjAPR4oMG2.XhCwJBakhq3WIw4uZqu08G.iQFtcN2dKSh+z8LgS2bQdl7Hl90v4YllzWpVQiknv6U=')
...
ky = LineClient(authToken='EGtDwvnXycYpg7RaoAp1.f04Z5tIwN8oo0wvkaqNsqq.w/rQFbb+bjl5LEy0CG2Of5rO+k8PycB0vnE4hRuuQ0c=')
...
sw = LineClient(authToken='EG2fCPEu9FZlRi2cDpn8.tgE9vbOaVvaGeRq5S9SqAa.EBHQaKcl96qQBmN9hVxSigwVHX2rbFBcQbpgh9PHTiw=')
...
wait = {
    ...
    "limit":5,
    "unsend":False,
    "mention":"B+ just not Blood group 😂😂..????",
    "Respontag":"waiting for Wi-Fi Signals.....! And You..!????????????",
    "welcome":"Welcome...",
    "leave":"Bye.. Hope See you next????????????...",
    "comment":"Super Like ",
    "message":"Lover is here ???? ",
    }
    ...
    try:
            ...
            if Cmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kc.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
            ...
            if Dmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        km.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
            ...
            if Emid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kb.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
            ...
            if Fmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kn.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
            ...
            if Gmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ko.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
            ...
            if Hmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kw.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
                        kw.leaveGroup(op.param1)
                    else:
                        kw.acceptGroupInvitation(op.param1)
                        ginfo = kw.getGroup(op.param1)
                        kw.sendMessage(op.param1,"Hi " + str(ginfo.name))
            if Imid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ke.acceptGroupInvitation(op.param1)
                        ginfo = ke.getGroup(op.param1)
                        ke.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
            ...
            if Jmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ky.sendMessage(op.param1,"Thanks For Add \n In Group " +str(ginfo.name))
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendContact(op.param1, "u21e925a9047f9310ecbe0c0f4950feab")
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                    if wait["Addimage"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Added successfully gambar {}".format(str(wait["Addimage"]["name"])))
               ...
               if msg.contentType == 2:
                 if msg._from in admin:
                    if wait["Addvideo"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Added successfully video {}".format(str(wait["Addvideo"]["name"])))
               ...
               if msg.contentType == 7:
                 if msg._from in admin:
                    if wait["Addsticker"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Added successfully sticker {}".format(str(wait["Addsticker"]["name"])))
               ...
               if msg.contentType == 3:
                 if msg._from in admin:
                    if wait["Addaudio"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Added successfully mp3 {}".format(str(wait["Addaudio"]["name"])))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                text = xpesan + zxc + ret_ + ""
                                cl.sendMessage(to, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)
                                cl.sendContact(to, "u21e925a9047f9310ecbe0c0f4950feab")
                            except Exception as e:
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "「 Status Lurking 」\nBerhasil activated, selanjutnya ketik lurkers\n\n• Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"Added successfully talkban")
                                       except:
                                           pass
